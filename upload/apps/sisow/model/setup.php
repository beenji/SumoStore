...
class ModelSetup extends App\Model
{
    ...
    {
        Sumo\Database::query("
            CREATE TABLE IF NOT EXISTS PREFIX_app_sisow (
        ...
        ");
        Sumo\Database::query("
            CREATE TABLE IF NOT EXISTS PREFIX_app_sisow_payments (
        ...
        ");
        Sumo\Database::query("
            CREATE TABLE IF NOT EXISTS PREFIX_app_sisow_payments_info (
