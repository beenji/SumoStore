...
<ul class="nav nav-tabs">
    ...
    <li class="<?php if ($list['store_id'] == $current_store){ echo 'active'; } ?>">
        <a href="<?php echo $this->url->link('app/shippingfree', 'token=' . $this->session->data['token'] . '&store_id=' . $list['store_id'], 'SSL')?>">
            <?php echo $list['name']?>
        </a>
    </li>
    <?php endforeach?>
    ...
    <div class="tab-pane active cont">
        <form method="post" action="" class="">
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        <label class="control-label"><?php echo Sumo\Language::getVar('APP_SHIPPINGPRODUCT_ENABLE')?></label>
            ...
            <div class="row settingstable">
                <div class="col-md-6">
                    <h4><?php echo Sumo\Language::getVar('APP_SHIPPINGPRODUCT_SETTINGS_FOR_GEOZONES')?></h4>
                </div>
                ...
                <div class="col-md-12">
                    <table class="">
                        ...
                        <tbody>
                                ...
                                <td style="width:150px;">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="general" class="form-control price including-tax" data-parsley-pattern="^[\d\.,]+$" data-parsley-trigger="keyup">
                                        </div>
                                    </div>
                                </td>
                            ...
                            <?php foreach ($zones as $list): ?>
                            <tr id="zone-<?php echo $list['geo_zone_id']?>" class="<?php if (empty($settings['zone'][$list['geo_zone_id']]['rate'])) { echo 'hidden'; }?>">
                                <td><?php echo $list['name']?></td>
                                <td style="width:150px;">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><?php echo $this->currency->getSymbolLeft()?></span>
                                            <input type="text" class="form-control price including-tax" data-parsley-pattern="^[\d\.,]+$" data-parsley-trigger="keyup">
                                        </div>
                                    </div>
                                </td>
                                <td style="width:200px;">
