    ...
    <div class="tab-pane active cont">
        <form method="post" action="" class="">
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        <label class="control-label"><?php echo Sumo\Language::getVar('APP_SHIPPINGFREE_ENABLE')?></label>
            ...
            <div class="row settingstable">
                <div class="col-md-6">
                    <h4><?php echo Sumo\Language::getVar('APP_SHIPPINGFREE_SETTINGS_FOR_GEOZONES')?></h4>
                </div>
