...
<ul class="nav nav-tabs">
    ...
    <li class="<?php if ($list['store_id'] == $current_store){ echo 'active'; } ?>">
        <a href="<?php echo $this->url->link('app/banktransfer', 'token=' . $this->session->data['token'] . '&store_id=' . $list['store_id'], 'SSL')?>">
            <?php echo $list['name']?>
        </a>
    </li>
    <?php endforeach?>
    ...
    <div class="tab-pane active cont">
        <form method="post" action="" class="form">
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        <label class="control-label"><?php echo Sumo\Language::getVar('APP_BANKTRANSFER_ENABLE')?></label>
            ...
            <div class="row settingstable">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label"><?php echo Sumo\Language::getVar('APP_BANKTRANSFER_PAYMENT_INSTRUCTIONS')?></label>
                        <?php foreach ($languages as $list): ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label"><?php echo Sumo\Language::getVar('APP_BANKTRANSFER_PAYMENT_STATUS')?></label>
                        <div class="">
            ...
            <div class="row settingstable">
                <div class="col-md-6">
                    <h4><?php echo Sumo\Language::getVar('APP_BANKTRANSFER_SETTINGS_FOR_GEOZONES')?></h4>
                </div>
