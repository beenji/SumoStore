        ...
        <div class="block-flat">
            ...
            <div>
                <form style="margin-bottom: 0px !important;" method="post" class="form-horizontal" action="<?php echo $action; ?>">
                    <div class="content">
                        <h4 class="title"><?php echo Sumo\Language::getVar('SUMO_NOUN_RESET_PASSWORD'); ?></h4>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="password" placeholder="<?php echo Sumo\Language::getVar('SUMO_NOUN_PASSWORD'); ?>" id="password" class="form-control">
                                </div>

                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-check align-center" style="width: 20px;"></i></span>
                                    <input type="text" name="confirm" placeholder="<?php echo Sumo\Language::getVar('SUMO_NOUN_PASSWORD_CONFIRM'); ?>" id="confirm" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="foot">
                        ...
                        <button class="btn btn-primary" type="submit"><?php echo Sumo\Language::getVar('SUMO_BUTTON_SAVE'); ?></button>
                    </div>
                </form>
            </div>
        </div>
