...
class ControllerSaleCustomerGroup extends Controller 
{
    ...
    protected function getList() 
    {
        ...
        $this->data['insert'] = $this->url->link('sale/customer_group/insert', 'token=' . $this->session->data['token'], 'SSL');
        $this->data['delete'] = $this->url->link('sale/customer_group/delete', 'token=' . $this->session->data['token'], 'SSL'); 
        $this->data['return'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'], 'SSL');    
        ...
        foreach ($results as $result) {
            ...
            $action[] = array(
                'text' => '<i class="table-edit"></i>',
                'href' => $this->url->link('sale/customer_group/update', 'token=' . $this->session->data['token'] . '&customer_group_id=' . $result['customer_group_id'], 'SSL')
            );        
        ...
        $translations = array(
            'heading_title', 'text_customer', 'text_no_results', 'column_name', 'column_sort_order', 'column_action', 'button_insert', 'button_delete'
        );
    ...
    protected function validateDelete() 
    {
        ...
        foreach ($this->request->post['selected'] as $customer_group_id) {
            ...
            $store_total = $this->model_settings_stores->getTotalStoresByCustomerGroupId($customer_group_id);
