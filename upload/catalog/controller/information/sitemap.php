...
class ControllerInformationSitemap extends Controller 
{
    public function index() 
    {
        ...
        $this->document->setTitle(Language::getVar('SUMO_SITEMAP_TITLE')); 
        ...
        $this->data['breadcrumbs'][] = array(
            'text'      => Language::getVar('SUMO_SITEMAP_TITLE'),
            'href'      => $this->url->link('information/sitemap'),          
            
        );    
        
        $this->data['heading_title'] = Language::getVar('SUMO_SITEMAP_TITLE');
        ...
        $this->data['text_search'] = Language::getVar('SUMO_NOUN_SEARCH_PLURAL');
