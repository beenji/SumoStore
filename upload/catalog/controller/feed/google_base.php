        ...
        if ($this->config->get('google_base_status')) { 
            ...
            foreach ($products as $product) {
                if ($product['description']) {
                    ...
                    $output .= '<link>' . $this->url->link('product/product', 'path=' . $this->getPath($product['category_id']) . '&product_id=' . $product['product_id']) . '</link>';
                    ...
                    //$output .= '<g:model>' . $product['model2'] . '</g:model>';
                    ...
                    $output .= '<g:mpn>' . $product['model_2'] . '</g:mpn>';
